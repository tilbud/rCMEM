...
|`shape`| numeric | g $\text{cm}^2$ | "linear" or "exponential" to describe the shape of the relationship between depth and belowground biomass
...
a <- multispecies_toplot %>% 
  ...
  scale_alpha_manual(values = c(0.0, 0.8, 0.8)) +
  theme(legend.position = "none") +
  xlab("elevation (Z, cm NAVD88)") +
  ylab(expression(paste("aboveground biomass (g ", cm^-2, ")")))
