...
testRoots <- massLiveRoots(layerBottom = seq(5, 40, by=5), layerTop=seq(0, 35, by=5),
                    totalRootMassPerArea = defaultParms$totalRootBiomass,
...
defaultSedIn <- sedimentInputs(suspendedSediment = defaultParms$suspendedSediment, # Suspended Sediment Concentration, mg per liter
...
for(ii in 1:100){
    noInputProfile <- addCohort(massPools = noInputProfile,
                               ...
                               mineralInput.fn = (function(...)0), #set 0 inputs
...
sampleStep<- 5
profile_by_depth <- convertProfileAgeToDepth(equProfile,
...
parametersToRun <- expand.grid(rootDepthMax=c(15, 30, 60), 
  ...
  do((function(xx){
    ...
    return(runToEquilibrium(rootTurnover = newParms$rootTurnover, 
                            ...
                            mineralInput.fn = sedimentInputs,
                            suspendedSediment = newParms$suspendedSediment, 
                            meanTidalHeight = newParms$depthBelowMHW, 
                            
                            massLiveRoots.fn = massLiveRoots,
                            totalRootMassPerArea = newParms$totalRootBiomass,
