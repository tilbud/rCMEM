...
{  
  ...
  scenario$mineral[1] <- initSedimentDelivery
  ...
  for (i in 2:nrow(scenario)) {
    ...
    dynamicBgb <- dynamicRootBiomass(z=surfaceElvZStar, bMax=exBMax/10000, zVegMax=zStarVegMax, zVegMin=zStarVegMin, 
                                     zVegPeak=zStarVegPeak, bgTurnover=exBgTurnover, rootShoot=exRootToShoot)
    dynamicMineralPool <- deliveredSediment3TidalCycle(z=scenario$surfaceElevation[i-1], MSL=scenario$MSL[i], MHW=scenario$MHW[i],
                                                       ...
                                                       ssc=scenario$ssc[i]/(1000*1000), q=exQ)
