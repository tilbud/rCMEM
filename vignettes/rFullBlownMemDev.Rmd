...
deliveredSedimentExample <- mapply(deliverSedimentSimple, z=targetElevation, meanSeaLevel=meanSeaLevel, meanHighWater=weightedMHW,
...
deliveredSedimentExample2 <- mapply(deliverSediment3TidalCycle, z=targetElevation, suspendedSediment=suspendedSediment, meanSeaLevel=meanSeaLevel,
                                    meanHighWater=meanHighWaterDatum, meanHighHighWater=meanHighHighWaterDatum, meanHighHighWaterSpring=meanHighHighWaterSpringDatum, settlingVelocity=settlingVelocity)
...
transectoutput <- runMemWithCohortsAccrossTransect(startYear=2015, relSeaLevelRiseInit=0.3, relSeaLevelRiseTotal=100,
                                      initElv=21.9, meanSeaLevel=7.4, 
                                      meanHighWaterDatum=16.9, meanHighHighWaterDatum=25.4,
                                      meanHighHighWaterSpringDatum=31.2, 
                                      suspendedSediment=3e-05, lunarNodalAmp=2.5, bMax=0.25, 
...
```{r animate Transect}
animateCohortsAccrossTransect(scenarioTransect = transectoutput[[1]], cohortsTransect = transectoutput[[2]],
...
start_time <- Sys.time()
memCohortExampleMultiSpp <- runMemWithCohorts(startYear=startYear, relSeaLevelRiseInit=relSeaLevelRiseInit, relSeaLevelRiseTotal=relSeaLevelRiseTotal,
                                      ...
                                      recalcitrantFrac=recalcitrantFrac, settlingVelocity=settlingVelocity,
                                      speciesCode=speciesCode)
print(Sys.time()-start_time)
...
# First we'll profile the script
start_time <- Sys.time()
memCohortExampleCraggySlr <- runMemWithCohorts(startYear=2015, relSeaLevelRiseInit=0.3, relSeaLevelRiseTotal=100,
...
# First we'll profile the script
start_time <- Sys.time()
memCohortHindCast <- runMemWithCohorts(startYear=1915,
...
start_time <- Sys.time()
memCohortExampleForecast <- runMemWithCohorts(startYear=2015, relSeaLevelRiseInit=0.3, relSeaLevelRiseTotal=100,
