...
source("R/fillDepthCellsWithRoots.R")
source("R/fillDepthsUsingSimpleCTM.R")
source("R/return_overlap.R")
source("R/depthIntervalsToAgeCohorts.R")
source('R/ageCohortsToDepthIntervals.R')
``` 
...
fillDepthsUsingSimpleCTM(totalDepth = 100, rootDepthMax = 45, totalRootBmass = 5000,
                         refractoryFrac = 0.3, bgTurnover = 1, ssc = 60, depthBelowMHW = 20,
