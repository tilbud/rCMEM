...
#' @export
runCohortMemTransect <- function(startYear, endYear=startYear+99, relSeaLevelRiseInit, relSeaLevelRiseTotal, initElv,
  ...
  for (i in 1:length(elvTransect)) {
    memOutputs <- runCohortMem(initElv = elvTransect[i],
                               ...
                               relSeaLevelRiseInit=relSeaLevelRiseInit, relSeaLevelRiseTotal=relSeaLevelRiseTotal,
                               meanSeaLevel=meanSeaLevel, meanSeaLevelDatum=meanSeaLevelDatum,
                               ...
                               lunarNodalAmp=lunarNodalAmp, lunarNodalPhase=lunarNodalPhase, nFloods=nFloods,
